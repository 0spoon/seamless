...
tags: ['created-by:agent', 'domain:runbook', 'project:example-backend', 'type:knowledge']
...
func TestMemoryFromV1(t *testing.T) {
	fm := v1Frontmatter{
		...
		Description: "desc",
		Project:     "agent-memory",
		Tags:        []string{"created-by:agent", "domain:gotcha", "project:example-firmware", "session:cc/abc123", "type:knowledge", "related:01ABC"},
		Created:     "2026-05-22T21:43:31Z",
		Modified:    "2026-07-09T18:46:48Z",
	}
	...
	require.Equal(t, "example-firmware", m.Project) // from project: tag, not storage bucket
...
func TestTrialFromV1(t *testing.T) {
	...
	fm := v1Frontmatter{
		...
		Tags:    []string{"lab:example-ble-lab", "type:trial"},
		Created: "2026-07-07T23:25:00Z",
	}
	tr := trialFromV1(fm, body, "research")
	require.Equal(t, "example-ble-lab", tr.Lab)
