---
title: Connect Cursor, Cline, Windsurf & Zed
description: Point any MCP client at Seamless's local streamable-HTTP endpoint with bearer auth - a verified config block per client, and an honest account of what a client without hooks does and does not get.
---
