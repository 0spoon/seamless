...
([RRF for agent recall](https://thereisnospoon.org/docs/concepts/reciprocal-rank-fusion/) defines the method
and the constant.)
...
([Sessions & briefings](https://thereisnospoon.org/docs/concepts/sessions/#the-budget-and-what-survives-it)).
...
retrieval surface - see [Memory & notes](https://thereisnospoon.org/docs/concepts/memory/).
