...
> How Seamless decides which project a call belongs to - the precedence chain, the fail-closed rule, and project families.
...
[The gardener](https://thereisnospoon.org/docs/concepts/gardener/), which handles it as a `split` rather than a
