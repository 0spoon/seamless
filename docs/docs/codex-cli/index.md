...
> Wire the shared local Codex host into Seamless - one app/CLI/IDE profile for hooks, the mcp-proxy tool bridge, skills, and reaper-driven session lifecycle.
...
same two independent halves as [Claude Code](https://thereisnospoon.org/docs/claude-code/) - **the MCP
...
they resume. See [Sessions & briefings](https://thereisnospoon.org/docs/concepts/sessions/) and the
...
then the [Troubleshooting](https://thereisnospoon.org/docs/guides/troubleshooting/) guide.

## Compatibility evidence

The maintained [Codex compatibility matrix](https://thereisnospoon.org/docs/reference/codex-compatibility/)
