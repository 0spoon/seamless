...
[Share one daemon across a LAN](https://thereisnospoon.org/docs/guides/network-install/) is the setup guide.
...
database to read the [optional features](https://thereisnospoon.org/docs/reference/console/#optional-features)
...
See [Share one daemon across a LAN](https://thereisnospoon.org/docs/guides/network-install/) for the whole
procedure.
