...
search. Add OpenAI or Ollama in the [configuration](https://thereisnospoon.org/docs/reference/configuration/)
...
[Projects & scope](https://thereisnospoon.org/docs/concepts/projects/) for the full precedence chain.
...
setup](https://thereisnospoon.org/docs/claude-code/) or [Codex local setup](https://thereisnospoon.org/docs/codex-cli/) for the client-specific
behavior.
...
- [Install & deploy](https://thereisnospoon.org/docs/install/) makes the daemon a service that survives
