...
> How plan mode is captured automatically - which hook does what, a plan's life from draft to approved, and the escape hatches.
...
The result is a [plan composition](https://thereisnospoon.org/docs/concepts/tasks-and-plans/) - narrative,
...
[seam CLI](https://thereisnospoon.org/docs/reference/cli-seam/).
