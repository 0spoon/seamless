...
> Putting ~/.seamless in git, what deleting seam.db actually costs, restoring by rebuilding the index, and moving to a new machine.
...
See [Install & deploy](https://thereisnospoon.org/docs/install/).
